        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form class="user" method="POST" action="{{ url('kategori-barang') }}">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="nama">Nama Kategori Barang</label>
                                <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Kategori Barang" name="nama" value="@if(count($errors) > 0){{ old('nama') }}@endif">
